...
<div>
    ...
    <div className="flex pad-top " style={{justifyContent: "space-around", paddingLeft: "10%"}}>
        ...
        <div className='col-6'><p>I have been working for myself as a web developer in Florida. My agencie's name is <Link to="https://formalflamingo.com" style={{color: "pink"}}> Formal Flamingo</Link>. </p></div>
